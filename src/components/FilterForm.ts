...
<div class="filters">
  ...
  <div class="filters-section">
    ...
    <div class="filters-sort-options">
      ...
      <label><input type="radio" name="sort" value="desc" checked> Descending</label>
    </div>
  </div>
  <hr class="filters-divider">
  ...
  <div class="filters-buttons">
    <button class="filters-apply-btn">Apply Filter</button>
    <button class="filters-reset-btn">Reset Filter</button>
  </div>
</div>
`;
